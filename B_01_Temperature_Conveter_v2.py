...
class Converter:
    ...
    def __init__(self):
        ...
        self.all_calculations_list =[['-12', '-7', '-1', '4', '4', '10', '16', '16']]

        # adds padding to the code
        ...
        # button list (button text I bg colour I command I row I column)
        button_details_list = [
    ...
    def convert(self, min_temp, to_convert):
        """
        Converts temperatures and updates answer label. Also stares
